...
export default function RiskFormClient() {
	...
	// Persist completion to localStorage when submitted
	useEffect(() => {
		if (!submitted) return
		try {
			const payload = {
			...
			localStorage.setItem("riskForm.completed", JSON.stringify(payload))
		} catch (err) {
			// ignore storage errors (e.g., private mode)
			// optional: show a non-blocking toast to the user
		}
	}, [submitted, mode, answers])
